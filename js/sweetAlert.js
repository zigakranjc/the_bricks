function showGameOver(time) {
    Swal.fire({
        title: `<div style="margin-top: 8vh; font-family: Arial, sans-serif;">GAME OVER!</div>`,
...
window.askPlayerName = function askPlayerName() {
    if (window.Swal && typeof window.Swal.fire === "function") {
        return window.Swal.fire({
            title: `<div style="margin-top: 8vh; font-family: Arial, sans-serif; color: #03056076;">YOUR NAME</div>`,
            input: "text",
...
aboutBtn.addEventListener("click", function () {
    if (window.Swal && typeof window.Swal.fire === "function") {
        window.Swal.fire({
            title: `<div style=" padding-top: 5vh; font-size: 20px; font-family: Arial, sans-serif; color: #03056076;">DEVELOPED BY</div>`,
...
function showWin(time) {
    Swal.fire({
        title: `<div style="margin-top: 8vh; font-family: Arial, sans-serif;">YOU WIN!</div>`,
